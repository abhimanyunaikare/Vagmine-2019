    ...
    <body class="hold-transition sidebar-mini">
        <div class="wrapper" id="app">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
              <!-- Brand Logo -->
                <a href="index3.html" class="brand-link" style="">
                    <img src="./img/logo.png" alt="" style="height: 1.9rem; margin-left: 15px;">
                    <span class="brand-text font-weight-light" style="margin-left:10px;">Vagmine</span>
                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                      <div class="image">
                      <img src="./img/user.png" alt="" style="height: 1.9rem;">
                      </div>
                      ...
                      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                          ...
                          <li class="nav-item has-treeview">
                              <a href="#" class="nav-link">
                                  <i class="fas fa-sliders-h green"></i>
                                  <p>
                                    Setup
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2019-2022 <a href="https://sahajayoga.org.in">Sahaja Yoga</a>.</strong> All rights reserved.
            </footer>
        </div>
        <!-- ./wrapper -->
